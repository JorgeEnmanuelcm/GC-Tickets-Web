<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdmPanel.aspx.cs" Inherits="GCTicketsWeb.AdmPanel" %>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12">
          <p>
            <a href="#" class="btn btn-sq-lg btn-primary">
                <i class="fa fa-align-left fa-5x"></i><br/>
                Registro Tipos de <br/> Eventos
            </a>
            <a href="#" class="btn btn-sq-lg btn-success">
              <i class="fa fa-align-left fa-5x"></i><br/>
              Consulta Tipos de <br/> Eventos
            </a>
            <a href="#" class="btn btn-sq-lg btn-warning">
              <i class="fa fa-align-left fa-5x"></i><br/>
              Reporte Tipos de <br/> Eventos
            </a>
          </p>
        </div>
	</div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12">
          <p>
            <a href="#" class="btn btn-sq-lg btn-primary">
                <i class="fa fa-hand-peace-o fa-5x"></i><br/>
                Registro Eventos <br/>
            </a>
            <a href="#" class="btn btn-sq-lg btn-success">
              <i class="fa fa-hand-peace-o fa-5x"></i><br/>
